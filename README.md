...
```
# Para ativar o XDP:
docker exec -it clab-gateway-ebpf-gateway ip link set dev eth1 xdpgeneric object /xdp_monitor.o section xdp

# Para verificar a ativação:
docker exec -it clab-gateway-ebpf-gateway ip link show eth1
```
